...
from datamodel.search.Dinhaq1Lochn2Jonat3_datamodel import Dinhaq1Lochn2Jonat3Link
...
@Deleter(Dinhaq1Lochn2Jonat3Link)
@Getter(Dinhaq1Lochn2Jonat3Link)
class DeleteFrontierFrame(IApplication):

    def __init__(self, frame):
        self.app_id = "Dinhaq1Lochn2Jonat3"
        self.frame = frame
    ...
    def update(self):
        ...
        ls = self.frame.get(Dinhaq1Lochn2Jonat3Link)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(Dinhaq1Lochn2Jonat3Link, l)
...
class Simulation(object):
    ...
    def __init__(self, address, port):
        ...
        objectless_connector = ObjectlessSpacetimeConnection(
            "ResetFrontier_Dinhaq1Lochn2Jonat3".format(CrawlerFrame.app_id),
